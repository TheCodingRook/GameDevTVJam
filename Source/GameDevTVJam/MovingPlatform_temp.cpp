...
void AMovingPlatform_temp::PostLoad()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("Found %i PuzzleComponents in %s"), PuzzleComponent.Num(), *PuzzleComponent[0]->GetName())
	ActorListComponent->ActorList = PuzzleComponent[0]->GetActorsList();
}
